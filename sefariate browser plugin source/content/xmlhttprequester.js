function sefariate_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
sefariate_xmlhttpRequester.prototype.contentStartRequest = function(details) {
	...
	switch (scheme) {
		...
		case "ftp":
			this.chromeWindow.setTimeout(
				sefariate_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
			break;
		default:
...
sefariate_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
sefariate_xmlhttpRequester.prototype.setupRequestEvent =
